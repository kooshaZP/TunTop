"""TunMood - route all of Windows through a VLESS proxy, beautifully.

One-line pitch: TunMood drives every byte your PC sends through a v2rayN
...
__version__ = "1.0.0"
__all__ = ["dashboard", "helper", "routing", "netdns", "geoip"]
